...
public class StormTopologyBuilder {
    ...
    public StormTopology build(ConsumerBolt hbaseBolt, String topic, String bootstrapServers) {
        final TopologyBuilder builder = new TopologyBuilder();
        final Fields fields = new Fields("topic", "key", "message");
        KafkaSpout<String, String> kafkaSpout = getKafkaSpout(topic, bootstrapServers);
    ...
    private KafkaSpout<String, String> getKafkaSpout(String topic, String bootstrapServers) {
        // Properties
